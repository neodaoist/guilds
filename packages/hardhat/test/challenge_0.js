...
describe("🚩 Challenge 0: 🎟 Simple NFT Example 🤓", function () {
  ...
  describe("TheGuildsOfSibiu", function () {
    if (process.env.CONTRACT_ADDRESS) {
      ...
      it("Should deploy TheGuildsOfSibiu", async function () {
        const TheGuildsOfSibiu = await ethers.getContractFactory(
          "TheGuildsOfSibiu"
        );
        myContract = await TheGuildsOfSibiu.deploy();
      });
    }
