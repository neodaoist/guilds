...
🕵🏻‍♂️ Inspect the `Debug Contracts` tab to figure out what address is the `owner` of `TheGuildsOfSibiu`?

🔏 You can also check out your smart contract `TheGuildsOfSibiu.sol` in `packages/hardhat/contracts`.
